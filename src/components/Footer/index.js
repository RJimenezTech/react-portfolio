  ...
  return (
    <section className="footer-section">
      <div className="footer-container">
        <a href="mailto:RJimenezTech@gmail.com" className="footer-cards">
          <img src={emailIcon} alt="email icon" />
          <h4>Email me</h4>
        </a>
        <a href="https://github.com/RJimenezTech" className="footer-cards">
          <img src={gitHubIcon} alt="github cat icon" />
          <h4>Check my GitHub</h4>
        </a>
        <a href="www.linkedin.com/in/RJimenezTech" className="footer-cards">
